...
const APP_VERSION = 'v5'; // ← CHANGE CE NUMÉRO À CHAQUE NOUVELLE VERSION D'INDEX.HTML
  ...
  event.respondWith(
    (async () => {
      ...
      try {
        ...
        // Pour une navigation de page (l'utilisateur ouvre/recharge
        // l'app), on retombe sur index.html s'il est en cache — ça
        // couvre le cas classique iOS où la requête de navigation exacte
        // (ex: une URL avec un paramètre) n'était pas caché telle quelle
        // mais que la page principale l'est.
